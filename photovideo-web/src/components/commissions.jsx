      ...
      <div id="carouselExampleCaptions" className="carousel slide">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/images/comissions/mnight6.png" className="d-block w-50" alt="..."></img>
          ...
          <div className="carousel-item">
            <img src="/images/comissions/mnight1.png" className="d-block w-50" alt="..."></img>
          
          </div>
          <div className="carousel-item">
            <img src="/images/comissions/mnight4.png" className="d-block w-50" alt="..."></img>
        
          </div>
           <div className="carousel-item">
            <img src="/images/comissions/nikegive3.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
           ...
           <div className="carousel-item">
            <img src="/images/comissions/nikegive.png" className="d-block w-50" alt="..."></img>
        
          </div>
         <div className="carousel-item">
            <img src="/images/comissions/apple1.PNG" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
           ...
           <div className="carousel-item">
            <img src="/images/comissions/apple2.PNG" className="d-block w-50" alt="..."></img>
          
          </div>
          <div className="carousel-item">
            <img src="/images/comissions/apple3.PNG" className="d-block w-50" alt="..."></img>
         
          </div>
         <div className="carousel-item">
            <img src="/images/comissions/apple4.PNG" className="d-block w-50" alt="..."></img>
         
          </div>
         <div className="carousel-item">
            <img src="/images/comissions/apple5.PNG" className="d-block w-50" alt="..."></img>
          
          </div>
           <div className="carousel-item">
            <img src="/images/comissions/apple6.PNG" className="d-block w-50" alt="..."></img>
         
          </div>
          <div className="carousel-item">
            <img src="/images/comissions/chakaia.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
              <h5 className='poppins-extralight-italic'>The New York Times</h5>
              <p>Chakaia Booker</p>
            </div>
          ...
          <div className="carousel-item">
            <img src="/images/comissions/vogue.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
        ...
        <div className="carousel-item">
            <img src="/images/comissions/vice-imani.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src="/images/comissions/espn2.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
            <img src="/images/comissions/espn.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
              <h5  className='poppins-extralight-italic'>ESPN</h5>
              <p>Anderson .Paak's Family</p>
            </div>
          ...
          <div className="carousel-item">
            <img src="/images/comissions/thewire.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src="/images/comissions/thewire2.png" className="d-block w-50" alt="..."></img>
            {/* <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src="/images/comissions/theatlantic.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src="/images/comissions/refinery.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src="/images/comissions/presbusts.png" className="d-block w-50" alt="..."></img>
            <div className="carousel-caption d-none d-md-block">
              <h5  className='poppins-extralight-italic'>The New York Times Magazine</h5>
          ...
          <div className="carousel-item">
            <img src="/images/comissions/presbusts2.png" className="d-block w-50" alt="..."></img>
            {/* <div className="carousel-caption d-none d-md-block">
